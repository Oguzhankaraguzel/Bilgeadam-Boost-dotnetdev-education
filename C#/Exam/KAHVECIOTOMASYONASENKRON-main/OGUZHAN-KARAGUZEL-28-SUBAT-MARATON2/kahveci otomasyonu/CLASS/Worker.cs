...
namespace kahveci_otomasyonu.CLASS
{
    public class Worker : Person
    {
        ...
        Task SetPrepare(Worker worker, int time ,string order) 
        {
            return Task.Run(() =>
            {
        ...
        /// <param name="time"></param>
        /// <param name="order"></param>
        public async void GetCashierforOrder(int time, string order, List<Worker> workers) 
        {
            ...
            await SetPrepare(_worker, time, order);
